...
[Files]
; 메인 실행파일
Source: "dist\ClockApp-Ver2.exe"; DestDir: "{app}"; Flags: ignoreversion
; 아이콘 파일들
Source: "*.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "clock_app.ico"; DestDir: "{app}"; Flags: ignoreversion
; 문서 파일들
Source: "LICENSE.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "README-Ver2.md"; DestDir: "{app}"; Flags: ignoreversion
; 설정 마이그레이션 스크립트
Source: "migrate_settings.py"; DestDir: "{app}"; Flags: ignoreversion
; Python 런타임 (필요시)
...
begin
  ...
  if not Result then
  begin
    MsgBox('ClockApp Ver2가 이미 실행 중입니다. 먼저 종료한 후 다시 시도해 주세요.', mbError, MB_OK);
  end;
end;
